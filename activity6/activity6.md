...
```txt
 EXPLAIN ANALYZE SELECT id, title FROM posts WHERE title LIKE '%dolor%';
QUERY PLAN  
-----------------------------------------------------------------------------------------------------------
 Seq Scan on posts  (cost=0.00..625.00 rows=1212 width=48) (actual time=0.015..2.970 rows=2015.00 loops=1)
